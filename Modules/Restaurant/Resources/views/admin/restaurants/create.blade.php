...
@section('content-header')
    <h1>
        {{ trans('restaurant::restaurants.title.create restaurant') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.restaurant.restaurant.index') }}">{{ trans('restaurant::restaurants.title.restaurants') }}</a></li>
        <li class="active">{{ trans('restaurant::restaurants.title.create restaurant') }}</li>
    </ol>
@stop
...
@section('content')
    {!! Form::open(['route' => ['admin.restaurant.restaurant.store'], 'method' => 'post']) !!}
    <div class="row">
        <div class="col-md-12">
