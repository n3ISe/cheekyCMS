...
@section('content-header')
    <h1>
        {{ trans('reportreason::reportreasons.title.create reportreason') }}
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('reportreason::reportreasons.title.create reportreason') }}</li>
    </ol>
@stop
...
@section('content')
    {!! Form::open(['route' => ['admin.reportreason.reportreason.store'], 'method' => 'post']) !!}
    <div class="row">
        <div class="col-md-12">
