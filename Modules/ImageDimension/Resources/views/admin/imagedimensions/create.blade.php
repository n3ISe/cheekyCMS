...
@section('content-header')
    <h1>
        {{ trans('imagedimension::imagedimensions.title.create imagedimension') }}
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('imagedimension::imagedimensions.title.create imagedimension') }}</li>
    </ol>
@stop
...
@section('content')
    {!! Form::open(['route' => ['admin.imagedimension.imagedimension.store'], 'method' => 'post']) !!}
    <div class="row">
        <div class="col-md-12">
