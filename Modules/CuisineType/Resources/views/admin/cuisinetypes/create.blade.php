...
@section('content-header')
    <h1>
        {{ trans('cuisinetype::cuisinetypes.title.create cuisinetype') }}
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('cuisinetype::cuisinetypes.title.create cuisinetype') }}</li>
    </ol>
@stop
...
@section('content')
    {!! Form::open(['route' => ['admin.cuisinetype.cuisinetype.store'], 'method' => 'post']) !!}
    <div class="row">
        <div class="col-md-12">
